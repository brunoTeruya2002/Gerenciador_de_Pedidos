  ...
  return (
    ...
    >
        ...
        {/* <div className="relative w-full sm:w-100 shadow-lg dark:shadow-gray-800 ">
          <div className="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
            <svg className="w-4 h-4 text-gray-500 dark:text-gray-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
              <MagnifyingGlass size={"auto"} weight="bold"/>
      ...
      <button type="submit" className="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xs px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buscar</button>
        ...
        <div className={`relative w-full sm:w-100 shadow-lg dark:shadow-gray-800  
        justify-around items-center text-xs text-gray-900 rounded-lg bg-gray-700 ${styles.searchHeader}`}>
          ...
          <div className={`${styles.alignSearchContent}`}>
            ...
            <input
              maxLength={30}
              className="block sm:w-60 w-full p-4 ps-4 sm:text-xs text-sm text-gray-300 focus:outline-none 
            "
        ...
        <div className={`${styles.alignButtonsFilterAndAdd} flex w-full sm:w-100
        items-center justify-center gap-2 flex-col-reverse`}>
          <div className="w-full">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-1 text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-xs px-5 py-2 text-center"
            >
          ...
          <div className="w-full">
            <button
              ...
              shadow-green-500/50 dark:shadow-lg dark:shadow-green-800/80 font-medium rounded-lg text-xs px-5 py-2
               text-center"
            >
        ...
        <table className=" w-full 2xl:w-1/2 lg:w-2/3 rounded-lg overflow-hidden text-sm text-center  text-gray-500 shadow-lg dark:shadow-gray-800">
          ...
          <tbody>
            {pedidos.map((row) => (
              <tr
                key={row.id}
                className="bg-white hover:bg-gray-50 text-xs odd:dark:bg-gray-800 odd:text-gray-400 even:dark:bg-gray-900 even:text-gray-400 transition-transform duration-200 ease-in-out hover:shadow-xl hover:scale-101"
              >
